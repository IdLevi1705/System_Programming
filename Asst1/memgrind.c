...
void test_D() {
    ...
    while (mallocCnt < 50) {
        ...
        if (random == 0) {
            mallocCnt++;
            int rand_size_1_to_64 = (rand() % 664 + 1);
...
int main(int argc, char** argv) {
    ...
    printf("****************************************************************************\n\n");
    printf("Total runs for Test A: %d\nAverage run time for test A is: %0.9lf miliseconds\n\n", totalRuns_test_A, totalTime_test_A / totalRuns_test_A * 100);
    printf("Total runs for Test B: %d\nAverage run time for test B is: %0.9lf miliseconds\n\n", totalRuns_test_B, totalTime_test_B / totalRuns_test_B * 100);
    printf("Total runs for Test C: %d\nAverage run time for test C is: %0.9lf miliseconds\n\n", totalRuns_test_C, totalTime_test_C / totalRuns_test_C * 100);
    printf("Total runs for Test D: %d\nAverage run time for test D is: %0.9lf miliseconds\n\n", totalRuns_test_D, totalTime_test_D / totalRuns_test_D * 100);
    printf("Total runs for Test E: %d\nAverage run time for test E is: %0.9lf miliseconds\n\n", totalRuns_test_E, totalTime_test_E / totalRuns_test_E * 100);
    printf("Total runs for Test F: %d\nAverage run time for test F is: %0.9lf miliseconds\n\n", totalRuns_test_F, totalTime_test_F / totalRuns_test_F * 100);
    return (0);
}
